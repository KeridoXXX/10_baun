...
<main id="bikinis-main">
	...
	<article class="single">
		...
		<div class="col-right">
			...
			<img src="http://lehmannen.dk/kea/10_baun/wp-content/uploads/2022/06/underskrift.png" alt="signature for singleview">
		</div>
...
<script>
	...
	function showBikiniSingular() {
		...
		document.querySelector(".beskrivelse").textContent = bikiniSingular.bikini_navn;
		document.querySelector(".pris").textContent = "kr " +  bikiniSingular.pris;
